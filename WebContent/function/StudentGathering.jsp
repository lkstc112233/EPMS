...
<title>EPMS-<s:property value="#session.role.name" />-免费师范生信息收集（<s:property value="annual.year" />）</title>
...
<div class="bag">
	<table style="width:80%"><tbody>
		<tr><td colspan="100">
			<div class="listHeader">
				免费师范生信息收集（<s:property value="annual.year" />）
			</div>
		</td></tr>
	...
	<jsp:include page="/model/search/TableOperationPage.jsp" flush="true">
		<jsp:param name="actionName" value="function_StudentGathering"/>
