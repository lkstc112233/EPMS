...
<title>EPMS-<s:property value="#session.role.name" />-返校督导详细信息（<s:property value="annual.year" />年）</title>
	...
	<tbody id="Table_1" style="display:;">
		...
		<s:iterator value="#__rpRow.list" var="__pairRow" status="__pairStatus">
			<tr class="wtableContent">
				...
				<!-- 经费 -->
				<s:form action="function_Supervise2Page_execute" method="post" theme="simple">
