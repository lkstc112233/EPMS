...
<title>EPMS-<s:property value="#session.role.name" />-确认布局规划（各实习基地学科接纳人数）（<s:property value="annual.year" />）</title>
...
<div class="bag">
	<table style="width:80%"><tbody>
		<tr><td colspan="100">
			<div class="listHeader">
				确认布局规划（<s:property value="annual.year" />）
			</div>
		</td></tr>
	...
	<jsp:include page="/model/search/TableOperationPage.jsp" flush="true">
		<jsp:param name="actionName" value="function_PlanDesign"/>
		<jsp:param name="joinParamPage" value="/model/search/joinparam/OnePage.jsp"/>

		<jsp:param name="poiBoolean" value="false"/>
		<jsp:param name="createBoolean" value="false"/>
		<jsp:param name="deleteBoolean" value="false"/>
	</jsp:include>
