 ...
 */
public class TableImport extends action.login.AnnualAction{
	private static final long serialVersionUID = 5998268336475528662L;
	
	public TableImport() throws SQLException, NoSuchFieldException, SecurityException{
		super();
	}
	...
	public String display(){
		this.jumpURL="jwc_function_TableOperation_display.action?tableName"+this.tableName;
		System.out.println(">> TableImportOperationAction:display <jump");
		return "jump";
	}
