...
public class POIExcel implements SQLIO, SpecialExcelIO{
	...
	public String getModelExcel(Class<? extends Base> clazz,
		...
		try(Workbook wb=new XSSFWorkbook();){
			...
			CellStyle styleTitle=POIExcel.getCellStyle(wb,"宋体",10,true,HorizontalAlignment.CENTER,BorderStyle.THIN);
			CellStyle styleContent=POIExcel.getCellStyle(wb,"宋体",10,false,HorizontalAlignment.CENTER,BorderStyle.THIN);
	...
	public String createStudentList(int year,PracticeBase pb, List<Student> students, String majorName, OutputStream out) throws IOException {
		...
		try(Workbook wb=new XSSFWorkbook();){
			...
			CellStyle styleBigTitle=POIExcel.getCellStyle(wb,"宋体",18,true,HorizontalAlignment.CENTER,BorderStyle.NONE);
			CellStyle styleSmallTitle=POIExcel.getCellStyle(wb,"宋体",12,true,HorizontalAlignment.CENTER,BorderStyle.NONE);
			CellStyle styleTitle=POIExcel.getCellStyle(wb,"宋体",10,true,HorizontalAlignment.CENTER,BorderStyle.NONE);
			CellStyle styleContent=POIExcel.getCellStyle(wb,"宋体",10,false,HorizontalAlignment.CENTER,BorderStyle.HAIR);
			//设置列数
